...
LanguagePack make_built_in_english() {
  ...
  pack.strings = {
    ...
    {"tabs.config", L"Config"},
    {"tabs.entries", L"Entries"},
    {"entries.name", L"Name"},
    {"entries.type", L"Type"},
    {"entries.target", L"Target"},
    {"entries.modified", L"Modified"},
    {"entries.path", L"Path"},
    {"entries.refresh", L"Refresh"},
    {"entries.add", L"Add..."},
    {"entries.rename", L"Rename"},
    {"entries.delete", L"Delete"},
    {"entries.new_name", L"New name"},
